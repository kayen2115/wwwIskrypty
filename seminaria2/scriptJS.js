document.addEventListener("DOMContentLoaded", function () {
  ...
  // dynamic elements
  document
    .getElementById("create-elements")
  ...
  document
    .getElementById("delete-elements")
    .addEventListener("click", function () {
  ...
  document.getElementById("start").addEventListener("click", function () {
    if (path.length > 0) {
      document
        .getElementById(`cell-${path[0][0]}-${path[0][1]}`)
        .appendChild(pawn);
      game = true;
    } else {
  ...
  document.getElementById("move").addEventListener("click", function () {
    ...
    if (currentIndex < path.length - 1) {
      ...
      document
        .getElementById(
          `cell-${path[currentIndex][0]}-${path[currentIndex][1]}`
        )
        .appendChild(pawn);
    } else {
  ...
  document.getElementById("reset").addEventListener("click", function () {
    ...
    document
      ...
      .forEach((cell) => cell.classList.remove("selected", "lastselected"));
    if (pawn.parentElement) {
